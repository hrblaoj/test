...
public class FragmentPageSelectedListAdapter {
    ...
    public FragmentPageSelectedListAdapter(View viewpage_item) {
    ...
    private View.OnClickListener onClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(v.equals( mPageListItems.get( index ).btnSingerName )){
                ...
                SongPlayManager.prioritySong( mPageListItems.get( index ).songInfo );
            }else if(v.equals( mPageListItems.get( index ).btnShanchu )){
                SongPlayManager.delSong( mPageListItems.get( index ).songInfo.song_id );
            }
        }
    };
